          ...
          <div class="card-body contacts_body">
            ...
            <li>
              <div class="d-flex bd-highlight">
                ...
                <div class="user_info">
                  <span>Costumer Service 1</span>
                  <p>Costumer Service 1 left 7 mins ago</p>
                </div>
              </div>
            </li>
...
$(document).ready(function() {
    ...
    function fetchMessages() {
        $.ajax({
            url: 'fetch_messages.php', // Replace with your PHP script handling message fetching
    ...
    setInterval(fetchMessages, 1000); // 1000 milliseconds = 1 seconds
});
</script>
