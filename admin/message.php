        ...
        function loadMessages(receiverUsername) {
          ...
          $.ajax({
            ...
            success: function(data) {
              ...
              $('.msg_cotainer').each(function() {
                var messageId = $(this).data('message-id'); // Assuming each message container has a data attribute for message ID
                $.post('update_message_status.php', { message_id: messageId }, function(response) {
